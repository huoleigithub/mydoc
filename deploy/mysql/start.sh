...
# 生成ssh key
docker exec -it mysql_master /bin/bash /etc/init.d/script/ssh_generate_key.sh -y
docker exec -it mysql_slave1 /bin/bash /etc/init.d/script/ssh_generate_key.sh -y
docker exec -it mysql_slave2 /bin/bash /etc/init.d/script/ssh_generate_key.sh-y
docker exec -it mha_manager /bin/bash /etc/init.d/script/ssh_generate_key.sh -y
# 授权ssh key
